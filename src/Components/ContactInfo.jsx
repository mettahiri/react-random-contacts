 ...
 *      - Traitement affichage et renvoie les infos à DisplayUserInfo component
 *     
 * @param {user} Object ==> toutes les information d'un contact 
 */
const UserInfo = ({user})=> {
                ...
                <section className="userMain">
                     ...
                     <div className="location">
                        <div className="locationInfo">
                             ...
                             <div>
                                 <h4><strong>Region :</strong> { user[0].location.state}</h4>
                                 <h4><strong>Ville :</strong> {user[0].location.city}</h4>
                             </div>
                        </div>
                        <div className="map">
